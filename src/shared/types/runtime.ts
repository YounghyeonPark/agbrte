 ...
 * present: external harnesses, and LoomHarness driven by a ModelProvider.
 *
...
/**
 * Where credentials live (§3.11). Loom never stores, proxies, or replays a
...
/** How much of a run's cost Loom can actually observe (§10). */
...
export interface AgentSpec {
  ...
  /** Which harness. */
  runtimeId: string;
  /** Required iff the harness is LoomHarness. */
  model?: ModelRef;
  auth: AuthMode;
