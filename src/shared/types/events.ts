...
export type EventBody =
  ...
  | {
       ...
       *
       * On the event, for the reason `free` above it is: which endpoint a seat used is a fact about the moment the turn ran. It now varies *between* turns as well. Every turn starts where
