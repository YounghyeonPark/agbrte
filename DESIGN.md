...
That leaves the **remote display grab** above as what it always was: a still, for the *model*. Watching the machine is the tunnel; showing the machine to an agent is a capture.
